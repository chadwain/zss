...
test "sdl" {
    ...
    for (cases.tree_data) |_, i| {
        ...
        const root_width = r.util.zssUnitToPixel(root_sizes.border_end.inline_dir - root_sizes.border_start.inline_dir);
        const root_height = r.util.zssUnitToPixel(root_sizes.border_end.block_dir - root_sizes.border_start.block_dir);
